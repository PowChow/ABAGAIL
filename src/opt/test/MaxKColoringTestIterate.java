 ...
 * @version 1.0
 */
public class MaxKColoringTestIterate {
    /** The n value */
    ...
    public static void main(String[] args) {
        ...
        for (int n=0; n<100; n++){
	     ...
	     double start = System.nanoTime();     
             fit = new FixedIterationTrainer(rhc, i * 200, ef); // original 200000
            fit.train();
        ...
        for (int n = 0; n < 100; n++){
         ...
         for (int i=1; i<100; i++){
	     double start = System.nanoTime();
             fit = new FixedIterationTrainer(sa, i * 200, ef);
...
int populationSize[] = new int[100];
    ...
    //int populationSize, int toMate, int toMutate
         ...
         for (int i=1; i<100; i++){
    	     double start = System.nanoTime();
             fit = new FixedIterationTrainer(ga, i * 5, ef);
             fit.train();
	...
	int trainCount[] = new int [100];
	    ...
	    for (int i = 1; i < 100; i++){
		    double start = System.nanoTime();
  	            ...
  	            fit = new FixedIterationTrainer(mimic, i * 10, ef);
     	            fit.train();
