...
public class CrxTest {
    ...
    /* update this section with dims of dataset from project 1 where hidden layers 2 were optimal */
    private static int inputLayer = 46, hiddenLayer = 2, outputLayer = 1;
    ...
    private static Instance[] initializeInstances(String dataFile, String labelFile) {
        ...
        try {
            ...
            for(int i = 0; i < instances.length; i++) {
                instances[i].setLabel(new Instance(labels[i].getData().get(0))); /* change if want multiclass */
            }
    ...
    public static void main(String[] args) {
        ...
        oa[1] = new SimulatedAnnealing(4E11, 1000, nnop[1]);
        oa[2] = new StandardGeneticAlgorithm(3000, 350, 75, nnop[2]);
